    ...
    <FadeIn className="fixed top-0 left-0 right-0 z-50">
      <header className="border-b border-white/10 bg-gradient-to-r from-orange-500/95 via-orange-600/95 to-orange-500/95 dark:from-blue-900/95 dark:via-blue-800/95 dark:to-blue-900/95 shadow-lg backdrop-blur-xl relative overflow-hidden group">
        ...
        <div className={`lg:hidden ${isMenuOpen ? "" : "hidden"}`}>
          <div className="fixed inset-y-0 right-0 z-50 w-full bg-orange-500 dark:bg-blue-900 px-6 py-6 sm:max-w-sm shadow-2xl">
            <div className="flex items-center justify-between">
              ...
              <button
                type="button"
                className="-m-2.5 rounded-md p-3 text-white hover:bg-white/10 active:bg-white/20 touch-manipulation"
                ...
                <div className="space-y-3 py-6">
                  {navItems.map((item) => (
                    <Link
                      key={item.name}
                      href={item.href}
                      className="-mx-3 block rounded-lg px-4 py-3.5 text-lg font-semibold leading-7 text-white hover:bg-orange-600 dark:hover:bg-blue-800 active:bg-orange-700 dark:active:bg-blue-700 touch-manipulation"
                      onClick={() => setIsMenuOpen(false)}
                    >
                      {item.name}
                    </Link>
                  ...
                  <button
                    ...
                    className="-mx-3 w-full text-left block rounded-lg px-4 py-3.5 text-lg font-semibold leading-7 text-white hover:bg-orange-600 dark:hover:bg-blue-800 active:bg-orange-700 dark:active:bg-blue-700 touch-manipulation flex items-center gap-3"
                  >
                    {theme === 'light' ? (
