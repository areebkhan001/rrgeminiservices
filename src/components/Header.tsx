              ...
              <div className="divide-y divide-white/20">
                {navItems.map((item) => (
                  <Link
                    key={item.name}
                    href={item.href}
                    className="block px-5 py-3.5 text-base font-semibold text-white hover:bg-orange-600 dark:hover:bg-blue-800 active:bg-orange-700 dark:active:bg-blue-700 touch-manipulation transition-colors"
                    onClick={() => setIsMenuOpen(false)}
                  >
                    {item.name}
                  </Link>
                ...
                <button
                  ...
                  className="w-full text-left px-5 py-3.5 text-base font-semibold text-white hover:bg-orange-600 dark:hover:bg-blue-800 active:bg-orange-700 dark:active:bg-blue-700 touch-manipulation flex items-center gap-3 transition-colors"
                >
                  {theme === 'light' ? (
